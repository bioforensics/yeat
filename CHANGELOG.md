...
### Fixed
- coronaSPAdes target snakemake output file (!)


## [0.9.2] 2026-05-07

### Fixed
- Applied `target_depth` downsampling setting to BBnorm (#111)
- Fastp minimum read length argument (#111)


## [0.9.1] 2026-04-30

### Changed
- Test to have same output behavior on different OS (#110)


## [0.9] 2026-04-30

### Added
- Digital normalization with BBMap (#109)

### Changed
- TOML file input format (#109)
